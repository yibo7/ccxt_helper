...
from ccxt_utils import ccxt_exchange
...
class JsonView(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        # jdata = txt_json # json.loads(txt_json, object_pairs_hook=collections.OrderedDict)
        ...
        gbox = QtWidgets.QGroupBox("fffff")
...
class JsonViewer(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        okex = ccxt_exchange(ccxt.okex)
        data = okex.fetch_l2_order_book('ETH/BTC', 12)
